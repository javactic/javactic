...
public interface OrFuture<G,B> {
    ...
    static <F, G, A, ERR> OrFuture<Vector<G>, Every<ERR>>
    ...
    static <F, G, A, I extends Iterable<? extends G>, ERR> OrFuture<I, Every<ERR>>
        ...
        Vector<OrFuture<? extends G, ? extends Every<? extends ERR>>> futures = Vector.empty();
        futures = javaslang.collection.Iterator.ofAll(iterable)
                .foldLeft(futures, (vec, elem) -> vec.append(f.apply(elem)));
        return combined(futures, collector);
    }
   
    @SafeVarargs
    static <G, ERR> OrFuture<G, Every<ERR>>
        when(OrFuture<? extends G, ? extends Every<? extends ERR>> or, Function<? super G, ? extends Validation<ERR>>... validations) {
    ...
    static <G, ERR, A, I extends Iterable<? extends G>> OrFuture<I, Every<ERR>>
        combined(Iterable<? extends OrFuture<? extends G, ? extends Every<? extends ERR>>> input, Collector<? super G, A, I> collector) {
        
        Queue<Or<? extends G, ? extends Every<? extends ERR>>> results = new ConcurrentLinkedQueue<>();
        OrPromise<I, Every<ERR>> promise = OrPromise.create();
        AtomicInteger count = new AtomicInteger(0);
        AtomicBoolean lastSet = new AtomicBoolean(false);
        for (Iterator<? extends OrFuture<? extends G, ? extends Every<? extends ERR>>> iterator = input.iterator(); iterator.hasNext();) {
    ...
    static <A, B, ERR> OrFuture<Tuple2<A, B>, Every<ERR>> zip(OrFuture<? extends A, ? extends Every<? extends ERR>> a,
                                                                     OrFuture<? extends B, ? extends Every<? extends ERR>> b) {
        return withGood(a, b, Tuple::of);
    }

    static <A, B, C, ERR> OrFuture<Tuple3<A, B, C>, Every<ERR>> zip3(OrFuture<? extends A, ? extends Every<? extends ERR>> a,
                                                                            OrFuture<? extends B, ? extends Every<? extends ERR>> b,

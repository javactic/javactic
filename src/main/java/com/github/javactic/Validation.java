 ...
 *
 * <pre>{@code
 * Or.<Integer, String>success(123).filter(this::isRound).filter(this::isDivBy3);
 ...
 *
 * <pre>{@code
 * Accumulation.when(Or.success(3), this::isRound, this::isDivBy3);
 * // Result: Bad(One(3 was not a round number))
 *
 * Accumulation.when(Or.success(4), this::isRound, this::isDivBy3);
